...
import { PlusCircle, Search, Edit, Trash2, Moon, Sun } from 'lucide-react'
...
const initialTasks: Task[] = [
  { id: 1, title: "Prepare meeting agenda", assignee: "John Doe", dueDate: "2023-12-10", status: "In Progress", priority: "High", category: "Planning" },
  { id: 2, title: "Send invitations", assignee: "Jane Smith", dueDate: "2023-12-12", status: "Completed", priority: "Medium", category: "Communication" },
  { id: 3, title: "Book venue", assignee: "Mike Johnson", dueDate: "2023-12-15", status: "Pending", priority: "Low", category: "Logistics" },
  { id: 4, title: "Prepare presentation slides", assignee: "Emily Brown", dueDate: "2023-12-18", status: "In Progress", priority: "High", category: "Content Creation" },
  { id: 5, title: "Review project proposal", assignee: "David Lee", dueDate: "2023-12-20", status: "Pending", priority: "Medium", category: "Review" },
]
...
export default function TasksPage() {
  ...
  const [newTask, setNewTask] = useState<Omit<Task, "id">>({ title: "", assignee: "", dueDate: "", status: "Pending", priority: "Medium", category: "" })
  ...
  const handleCreateTask = () => {
    ...
    setNewTask({ title: "", assignee: "", dueDate: "", status: "Pending", priority: "Medium", category: "" })
  ...
  return (
    <div className={`min-h-screen p-8 transition-colors duration-200 ${isDarkMode ? 'dark bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <TaskCategoryPieChart tasks={tasks} />
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-100 dark:bg-gray-700">
                    ...
                    <TableHead className="font-semibold text-gray-700 dark:text-gray-300">Assignee</TableHead>
                    ...
                    <TableRow key={task.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <TableCell>
                        <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                          ...
                          task.priority === 'Medium' ? 'bg-orange-100 text-orange-800 dark:bg-orange-800 dark:text-orange-100' :
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          <Button variant="outline" size="sm" onClick={() => handleDeleteTask(task.id)} className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300">
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setEditingTask(editingTask ? { ...editingTask, status: value as Task['status'] } : null)}
                >
                  <SelectTrigger className="col-span-3">
                    <SelectValue placeholder="Select a status" />
                  </SelectTrigger>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setEditingTask(editingTask ? { ...editingTask, priority: value as Task['priority'] } : null)}
                >
                  <SelectTrigger className="col-span-3">
                    <SelectValue placeholder="Select a priority" />
                  </SelectTrigger>
            ...
            <DialogFooter>
              <Button type="submit" onClick={handleEditTask}>Save Changes</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
